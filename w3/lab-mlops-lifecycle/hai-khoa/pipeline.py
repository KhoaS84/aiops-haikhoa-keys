"""
pipeline.py — Train IsolationForest pipeline on baseline data, log to MLflow, register model.
...
def train(
    ...
    # Use a Pipeline combining StandardScaler and IsolationForest to handle scaling automatically during serving
    pipeline = Pipeline([
    ...
    with mlflow.start_run() as run:
        ...
        # Log scaler as artifact (needed for baseline compatibility)
        import pickle
        import tempfile
